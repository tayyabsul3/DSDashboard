...
const Dashboard = () => {
  ...
  return (
    <div className="transition-all duration-300 ease-in-out body p-5 lg:py-5 lg:px-16 flex flex-col gap-5 h-[85vh] overflow-y-auto">
      ...
      <div className="flex flex-col gap-5">
        ...
        <div className="flex gap-5 flex-col xl:flex-row w-full">
          <div className="flex flex-col gap-5 flex-[0.7]">
            <div className="flex-[0.8] p-0">
              <Graph />
            </div>
            <div className="sidegraphs flex gap-5 flex-col lg:flex-row w-full flex-1s">
